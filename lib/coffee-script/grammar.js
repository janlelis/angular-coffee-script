...
(function() {
  ...
  grammar = {
    ...
    Param: [
      ...
      }), o('AngularScope', function() {
        return new Param(new Literal('$scope'));
      })
    ],
    ...
    SimpleAssignable: [
      ...
      }), o('ThisProperty'), o('AngularScopeProperty'), o('AngularScope')
    ],
    Assignable: [
    ...
    AngularScopeProperty: [
      o('@ @ Identifier', function() {
        return new Value(LOC(1)(new Literal('$scope')), [LOC(2)(new Access($3))], '$scope');
      })
    ],
    AngularScope: [
      o('@ @', function() {
        return new Value(new Literal('$scope'));
      })
    ],
    This: [
      o('THIS', function() {
